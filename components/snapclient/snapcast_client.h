...
class SnapcastClient {
 ...
 protected:
  ...
  /// Slow-filtered ring depth (tau ~30 s). Anything that sizes a GAIN uses this; the live fill
  /// collapses under starvation and would make the loop most aggressive when it is least able to
  /// afford it.
